...
package com.hunglv.office.fc.hssf.usermodel;
...
import com.hunglv.office.fc.POIDocument;
import com.hunglv.office.fc.codec.DigestUtils;
import com.hunglv.office.fc.ddf.EscherBSERecord;
import com.hunglv.office.fc.ddf.EscherBitmapBlip;
import com.hunglv.office.fc.ddf.EscherBlipRecord;
import com.hunglv.office.fc.ddf.EscherRecord;
import com.hunglv.office.fc.hssf.OldExcelFormatException;
import com.hunglv.office.fc.hssf.formula.FormulaShifter;
import com.hunglv.office.fc.hssf.formula.FormulaType;
import com.hunglv.office.fc.hssf.formula.SheetNameFormatter;
import com.hunglv.office.fc.hssf.formula.ptg.Area3DPtg;
import com.hunglv.office.fc.hssf.formula.ptg.MemFuncPtg;
import com.hunglv.office.fc.hssf.formula.ptg.Ptg;
import com.hunglv.office.fc.hssf.formula.ptg.UnionPtg;
import com.hunglv.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import com.hunglv.office.fc.hssf.formula.udf.UDFFinder;
import com.hunglv.office.fc.hssf.model.DrawingManager2;
import com.hunglv.office.fc.hssf.model.HSSFFormulaParser;
import com.hunglv.office.fc.hssf.model.InternalSheet;
import com.hunglv.office.fc.hssf.model.InternalWorkbook;
import com.hunglv.office.fc.hssf.model.RecordStream;
import com.hunglv.office.fc.hssf.record.AbstractEscherHolderRecord;
import com.hunglv.office.fc.hssf.record.BackupRecord;
import com.hunglv.office.fc.hssf.record.DrawingGroupRecord;
import com.hunglv.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
import com.hunglv.office.fc.hssf.record.ExtendedFormatRecord;
import com.hunglv.office.fc.hssf.record.FontRecord;
import com.hunglv.office.fc.hssf.record.LabelRecord;
import com.hunglv.office.fc.hssf.record.LabelSSTRecord;
...
import com.hunglv.office.fc.hssf.record.RecordFactory;
import com.hunglv.office.fc.hssf.record.SSTRecord;
import com.hunglv.office.fc.hssf.record.SubRecord;
import com.hunglv.office.fc.hssf.record.UnknownRecord;
...
import com.hunglv.office.fc.hssf.util.CellReference;
import com.hunglv.office.fc.poifs.filesystem.DirectoryNode;
import com.hunglv.office.fc.poifs.filesystem.POIFSFileSystem;
import com.hunglv.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.hunglv.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements com.hunglv.office.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see com.hunglv.office.fc.poifs.filesystem.POIFSFileSystem
...
//            names.add(name);
    ...
    /**
      ...
      * @see com.hunglv.office.fc.hssf.record.LabelRecord
      * @see com.hunglv.office.fc.hssf.record.LabelSSTRecord
     ...
     * @see com.hunglv.office.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link com.hunglv.office.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(com.hunglv.office.fc.ss.usermodel.Sheet sheet)
    {
