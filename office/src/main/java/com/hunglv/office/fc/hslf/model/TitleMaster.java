...
public final class TitleMaster extends MasterSheet
{
     ...
     *
     */
    public TitleMaster(com.hunglv.office.fc.hslf.record.Slide record, int sheetNo)
    {
    ...
    public MasterSheet getMasterSheet()
    {
        ...
        SlideAtom sa = ((com.hunglv.office.fc.hslf.record.Slide)getSheetContainer()).getSlideAtom();
