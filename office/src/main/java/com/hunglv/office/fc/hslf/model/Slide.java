...
package com.hunglv.office.fc.hslf.model;
...
import com.hunglv.office.fc.hslf.record.ColorSchemeAtom;
import com.hunglv.office.fc.hslf.record.Comment2000;
...
import com.hunglv.office.fc.hslf.record.TextHeaderAtom;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.hunglv.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.hunglv.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.hunglv.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.hunglv.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.hunglv.office.fc.hslf.record.Slide)getSheetContainer();
    }
