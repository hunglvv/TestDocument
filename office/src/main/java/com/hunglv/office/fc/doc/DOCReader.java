...
package com.hunglv.office.fc.doc;
...
import com.hunglv.office.common.bookmark.Bookmark;
import com.hunglv.office.common.borders.Border;
import com.hunglv.office.common.borders.Borders;
import com.hunglv.office.common.borders.Line;
import com.hunglv.office.common.bulletnumber.ListData;
import com.hunglv.office.common.bulletnumber.ListLevel;
import com.hunglv.office.common.hyperlink.Hyperlink;
import com.hunglv.office.common.picture.Picture;
...
import com.hunglv.office.common.shape.WPAbstractShape;
import com.hunglv.office.common.shape.WPAutoShape;
import com.hunglv.office.common.shape.WPGroupShape;
import com.hunglv.office.common.shape.WPPictureShape;
...
import com.hunglv.office.fc.ddf.EscherContainerRecord;
import com.hunglv.office.fc.ddf.EscherOptRecord;
import com.hunglv.office.fc.ddf.EscherProperties;
import com.hunglv.office.fc.ddf.EscherSimpleProperty;
import com.hunglv.office.fc.ddf.EscherTextboxRecord;
import com.hunglv.office.fc.hwpf.HWPFDocument;
import com.hunglv.office.fc.hwpf.model.FieldsDocumentPart;
import com.hunglv.office.fc.hwpf.model.ListFormatOverride;
import com.hunglv.office.fc.hwpf.model.ListTables;
import com.hunglv.office.fc.hwpf.model.POIListData;
import com.hunglv.office.fc.hwpf.model.POIListLevel;
import com.hunglv.office.fc.hwpf.model.PicturesTable;
import com.hunglv.office.fc.hwpf.usermodel.Bookmarks;
import com.hunglv.office.fc.hwpf.usermodel.BorderCode;
import com.hunglv.office.fc.hwpf.usermodel.CharacterRun;
import com.hunglv.office.fc.hwpf.usermodel.Field;
import com.hunglv.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.hunglv.office.fc.hwpf.usermodel.HWPFShape;
import com.hunglv.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.hunglv.office.fc.hwpf.usermodel.HeaderStories;
import com.hunglv.office.fc.hwpf.usermodel.InlineWordArt;
import com.hunglv.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.hunglv.office.fc.hwpf.usermodel.OfficeDrawing;
import com.hunglv.office.fc.hwpf.usermodel.OfficeDrawings;
import com.hunglv.office.fc.hwpf.usermodel.POIBookmark;
import com.hunglv.office.fc.hwpf.usermodel.Paragraph;
import com.hunglv.office.fc.hwpf.usermodel.PictureType;
import com.hunglv.office.fc.hwpf.usermodel.Range;
import com.hunglv.office.fc.hwpf.usermodel.Section;
import com.hunglv.office.fc.hwpf.usermodel.Table;
import com.hunglv.office.fc.hwpf.usermodel.TableCell;
import com.hunglv.office.fc.hwpf.usermodel.TableRow;
import com.hunglv.office.fc.util.LittleEndian;
import com.hunglv.office.java.awt.Rectangle;
import com.hunglv.office.java.util.Arrays;
...
import com.hunglv.office.simpletext.model.IElement;
...
import com.hunglv.office.simpletext.view.PageAttr;
import com.hunglv.office.ss.util.ModelUtil;
import com.hunglv.office.system.AbstractReader;
import com.hunglv.office.system.IControl;
import com.hunglv.office.wp.model.CellElement;
import com.hunglv.office.wp.model.HFElement;
import com.hunglv.office.wp.model.RowElement;
import com.hunglv.office.wp.model.TableElement;
import com.hunglv.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.hunglv.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.hunglv.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.hunglv.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.hunglv.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
