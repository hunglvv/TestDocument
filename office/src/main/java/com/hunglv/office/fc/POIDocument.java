...
import com.hunglv.office.fc.hpsf.DocumentSummaryInformation;
import com.hunglv.office.fc.hpsf.MutablePropertySet;
import com.hunglv.office.fc.hpsf.PropertySet;
import com.hunglv.office.fc.hpsf.PropertySetFactory;
import com.hunglv.office.fc.hpsf.SummaryInformation;
import com.hunglv.office.fc.poifs.filesystem.DirectoryEntry;
import com.hunglv.office.fc.poifs.filesystem.DirectoryNode;
import com.hunglv.office.fc.poifs.filesystem.DocumentInputStream;
import com.hunglv.office.fc.poifs.filesystem.Entry;
import com.hunglv.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.hunglv.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.hunglv.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.hunglv.office.fc.hpsf.WritingNotSupportedException wnse)
        {
