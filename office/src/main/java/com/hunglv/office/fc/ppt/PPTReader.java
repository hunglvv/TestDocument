 ...
 * 时间:               下午4:23:51
 */
package com.hunglv.office.fc.ppt;
...
import com.hunglv.office.common.PaintKit;
import com.hunglv.office.common.autoshape.ExtendPath;
import com.hunglv.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.hunglv.office.common.bg.BackgroundAndFill;
import com.hunglv.office.common.bg.Gradient;
import com.hunglv.office.common.bg.LinearGradientShader;
import com.hunglv.office.common.bg.RadialGradientShader;
import com.hunglv.office.common.bg.TileShader;
import com.hunglv.office.common.hyperlink.Hyperlink;
import com.hunglv.office.common.pictureefftect.PictureEffectInfoFactory;
import com.hunglv.office.common.shape.AbstractShape;
import com.hunglv.office.common.shape.ArbitraryPolygonShape;
import com.hunglv.office.common.shape.Arrow;
import com.hunglv.office.common.shape.AutoShape;
import com.hunglv.office.common.shape.GroupShape;
import com.hunglv.office.common.shape.IShape;
import com.hunglv.office.common.shape.LineShape;
import com.hunglv.office.common.shape.PictureShape;
import com.hunglv.office.common.shape.ShapeTypes;
import com.hunglv.office.common.shape.TableCell;
import com.hunglv.office.common.shape.TableShape;
import com.hunglv.office.common.shape.TextBox;
import com.hunglv.office.constant.AutoShapeConstant;
import com.hunglv.office.constant.EventConstant;
import com.hunglv.office.constant.MainConstant;
import com.hunglv.office.constant.wp.WPAttrConstant;
import com.hunglv.office.constant.wp.WPModelConstant;
import com.hunglv.office.fc.FCKit;
import com.hunglv.office.fc.ShapeKit;
import com.hunglv.office.fc.hslf.HSLFSlideShow;
import com.hunglv.office.fc.hslf.model.Fill;
import com.hunglv.office.fc.hslf.model.HeadersFooters;
import com.hunglv.office.fc.hslf.model.Line;
import com.hunglv.office.fc.hslf.model.MasterSheet;
import com.hunglv.office.fc.hslf.model.Notes;
import com.hunglv.office.fc.hslf.model.Shape;
import com.hunglv.office.fc.hslf.model.ShapeGroup;
import com.hunglv.office.fc.hslf.model.Sheet;
import com.hunglv.office.fc.hslf.model.SimpleShape;
import com.hunglv.office.fc.hslf.model.Slide;
import com.hunglv.office.fc.hslf.model.SlideMaster;
import com.hunglv.office.fc.hslf.model.TextShape;
import com.hunglv.office.fc.hslf.model.TitleMaster;
import com.hunglv.office.fc.hslf.record.BinaryTagDataBlob;
import com.hunglv.office.fc.hslf.record.ClientVisualElementContainer;
import com.hunglv.office.fc.hslf.record.DocumentAtom;
import com.hunglv.office.fc.hslf.record.OEPlaceholderAtom;
import com.hunglv.office.fc.hslf.record.PositionDependentRecordContainer;
import com.hunglv.office.fc.hslf.record.Record;
import com.hunglv.office.fc.hslf.record.SlideAtom;
import com.hunglv.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.hunglv.office.fc.hslf.record.SlideProgTagsContainer;
import com.hunglv.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.hunglv.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.hunglv.office.fc.hslf.record.TimeNodeContainer;
import com.hunglv.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.hunglv.office.fc.hslf.record.TimeVariant;
import com.hunglv.office.fc.hslf.record.VisualShapeAtom;
import com.hunglv.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.hunglv.office.fc.hslf.usermodel.PictureData;
import com.hunglv.office.fc.hslf.usermodel.RichTextRun;
import com.hunglv.office.fc.hslf.usermodel.SlideShow;
import com.hunglv.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.hunglv.office.fc.ss.usermodel.Textbox;
import com.hunglv.office.java.awt.Dimension;
import com.hunglv.office.java.awt.Rectangle;
import com.hunglv.office.java.awt.Rectanglef;
import com.hunglv.office.java.awt.geom.Rectangle2D;
import com.hunglv.office.pg.animate.ShapeAnimation;
import com.hunglv.office.pg.model.PGModel;
import com.hunglv.office.pg.model.PGNotes;
import com.hunglv.office.pg.model.PGSlide;
import com.hunglv.office.simpletext.font.FontTypefaceManage;
import com.hunglv.office.simpletext.model.AttrManage;
import com.hunglv.office.simpletext.model.IAttributeSet;
import com.hunglv.office.simpletext.model.LeafElement;
import com.hunglv.office.simpletext.model.ParagraphElement;
import com.hunglv.office.simpletext.model.SectionElement;
import com.hunglv.office.ss.util.format.NumericFormatter;
import com.hunglv.office.system.AbstractReader;
import com.hunglv.office.system.BackReaderThread;
...
{   
    ...
    private com.hunglv.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.hunglv.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.hunglv.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.hunglv.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.hunglv.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.hunglv.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.hunglv.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.hunglv.office.fc.hslf.model.AutoShape  // 文本框 
                    || shape instanceof com.hunglv.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.hunglv.office.fc.hslf.model.Freeform
            || shape instanceof com.hunglv.office.fc.hslf.model.AutoShape
            || shape instanceof com.hunglv.office.fc.hslf.model.TextBox
            || shape instanceof com.hunglv.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.hunglv.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.hunglv.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.hunglv.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.hunglv.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect, 
            ...
            else if(shape instanceof com.hunglv.office.fc.hslf.model.AutoShape
                    || shape instanceof com.hunglv.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.hunglv.office.fc.hslf.model.Picture)
            {   
                com.hunglv.office.fc.hslf.model.Picture poiPic = (com.hunglv.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.hunglv.office.fc.hslf.model.Table)
        {
            com.hunglv.office.fc.hslf.model.Table poiTable = (com.hunglv.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.hunglv.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.hunglv.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.hunglv.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.hunglv.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.hunglv.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.hunglv.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.hunglv.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.hunglv.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.hunglv.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
