 ...
 * 时间:              下午1:55:20
 */
package com.hunglv.office.ss.model.XLSModel;
...
import com.hunglv.office.common.shape.AChart;
...
import com.hunglv.office.constant.SSConstant;
import com.hunglv.office.fc.hssf.model.InternalSheet;
import com.hunglv.office.fc.hssf.model.InternalWorkbook;
import com.hunglv.office.fc.hssf.record.BlankRecord;
...
import com.hunglv.office.fc.hssf.usermodel.HSSFAutoShape;
import com.hunglv.office.fc.hssf.usermodel.HSSFChart;
import com.hunglv.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.hunglv.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.hunglv.office.fc.hssf.usermodel.HSSFFreeform;
import com.hunglv.office.fc.hssf.usermodel.HSSFLine;
import com.hunglv.office.fc.hssf.usermodel.HSSFPatriarch;
import com.hunglv.office.fc.hssf.usermodel.HSSFPicture;
import com.hunglv.office.fc.hssf.usermodel.HSSFPictureData;
import com.hunglv.office.fc.hssf.usermodel.HSSFRichTextString;
import com.hunglv.office.fc.hssf.usermodel.HSSFShape;
import com.hunglv.office.fc.hssf.usermodel.HSSFShapeGroup;
import com.hunglv.office.fc.hssf.usermodel.HSSFSheet;
import com.hunglv.office.fc.hssf.usermodel.HSSFTextbox;
import com.hunglv.office.fc.hssf.usermodel.HSSFWorkbook;
import com.hunglv.office.fc.hssf.util.HSSFPaneInformation;
import com.hunglv.office.fc.ss.util.HSSFCellRangeAddress;
import com.hunglv.office.fc.xls.ChartConverter;
import com.hunglv.office.java.awt.Rectangle;
import com.hunglv.office.ss.model.CellRangeAddress;
import com.hunglv.office.ss.model.baseModel.Cell;
import com.hunglv.office.ss.model.baseModel.Row;
import com.hunglv.office.ss.model.baseModel.Sheet;
import com.hunglv.office.ss.model.baseModel.Workbook;
import com.hunglv.office.ss.model.drawing.AnchorPoint;
import com.hunglv.office.ss.model.drawing.CellAnchor;
import com.hunglv.office.ss.model.sheetProperty.PaneInformation;
import com.hunglv.office.ss.util.ModelUtil;
import com.hunglv.office.ss.util.SectionElementFactory;
...
import com.hunglv.office.thirdpart.achartengine.chart.AbstractChart;
import com.hunglv.office.thirdpart.achartengine.chart.RoundChart;
import com.hunglv.office.thirdpart.achartengine.chart.XYChart;
import com.hunglv.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.hunglv.office.fc.ss.usermodel.Sheet
{
     ...
     * @see com.hunglv.office.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.hunglv.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.hunglv.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.hunglv.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.hunglv.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.hunglv.office.ss.model.sheetProperty.ColumnInfo(
