...
package com.hunglv.office.officereader.filelist;
...
public class FileItemAdapter extends BaseAdapter
{
    ...
    {       
        ...
        // folder        
        iconMap.put(ICON_TYPE_FOLDER, ResourcesCompat.getDrawable(res, R.drawable.file_folder, null));
        // doc
        iconMap.put(ICON_TYPE_DOC, ResourcesCompat.getDrawable(res, R.drawable.file_doc, null));
        // docx
        iconMap.put(ICON_TYPE_DOCX, ResourcesCompat.getDrawable(res, R.drawable.file_docx, null));
        // xls
        iconMap.put(ICON_TYPE_XSL, ResourcesCompat.getDrawable(res, R.drawable.file_xls, null));
        // xlsx
        iconMap.put(ICON_TYPE_XLSX, ResourcesCompat.getDrawable(res, R.drawable.file_xlsx, null));
        // ppt
        iconMap.put(ICON_TYPE_PPT, ResourcesCompat.getDrawable(res, R.drawable.file_ppt, null));
        // pptx
        iconMap.put(ICON_TYPE_PPTX, ResourcesCompat.getDrawable(res, R.drawable.file_pptx, null));
        // txt
        iconMap.put(ICON_TYPE_TXT, ResourcesCompat.getDrawable(res, R.drawable.file_txt, null));
        // stat
        iconMap.put(ICON_TYPE_STAR, ResourcesCompat.getDrawable(res, R.drawable.file_icon_star, null));
        // pdf
        iconMap.put(ICON_TYPE_PDF, ResourcesCompat.getDrawable(res, R.drawable.file_pdf, null));
    }
