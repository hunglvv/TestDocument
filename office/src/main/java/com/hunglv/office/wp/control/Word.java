package com.hunglv.office.wp.control;
...
import com.hunglv.office.pg.animate.FadeAnimation;
import com.hunglv.office.simpletext.control.Highlight;
import com.hunglv.office.simpletext.control.IHighlight;
import com.hunglv.office.simpletext.control.IWord;
...
import com.hunglv.office.system.beans.pagelist.APageListView;
import com.hunglv.office.wp.view.LayoutKit;
import com.hunglv.office.wp.view.NormalRoot;
import com.hunglv.office.wp.view.PageRoot;
import com.hunglv.office.wp.view.PageView;
import com.hunglv.office.wp.view.WPViewKit;
...
public class Word extends LinearLayout implements IWord {
    ...
    /**
     * wordWidth The wordWidth to set.
     */
    ...
    /**
     * wordHeight The wordHeight to set.
     */
     ...
     * @return
     */
    public FadeAnimation getParagraphAnimation(int paragraphID) {
        return null;
    }
