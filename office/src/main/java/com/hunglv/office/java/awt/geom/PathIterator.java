...
package com.hunglv.office.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link com.hunglv.office.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link com.hunglv.office.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see com.hunglv.office.fc.hwpf.usermodel.Shape
 * @see com.hunglv.office.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
