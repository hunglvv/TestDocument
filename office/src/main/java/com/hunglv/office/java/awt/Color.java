...
public class Color implements java.io.Serializable
{
     ...
     * @see        com.hunglv.office.java.awt.Color#darker
     * @since      JDK1.0
     */
     ...
     * @see        com.hunglv.office.java.awt.Color#brighter
     * @since      JDK1.0
     */
    public Color darker()
    {
     ...
     * @see      com.hunglv.office.java.awt.Color#Color(int)
     * @since    JDK1.0
     */
     ...
     * @see       com.hunglv.office.java.awt.Color#getRGB()
     * @see       com.hunglv.office.java.awt.Color#Color(int)
     * @see       java.awt.image.ColorModel#getRGBdefault()
     * @since     JDK1.0
     */
